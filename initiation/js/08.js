...
for (var i = 1; i <= 10 ; i+=2) {
    document.write("<p>Instruction exécutée : " + i + "</p>"); //Tant qu'il est inferieur à 10 il execute l'operation 
}
"</hr >";
...
var monCompte = 1000;
var temps = 0;
while(monCompte < 2000) { //tant que mon compte est inférieur a 2000
